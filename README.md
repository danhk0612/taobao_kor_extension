...
- 팝업에서 확장 기능 ON/OFF
- 옵션 페이지에서 번역 API 사용 여부 및 엔드포인트 설정 (LibreTranslate / DeepL / Custom 선택)
...
- 기본값은 내장 사전 기반 번역입니다.
- 더 넓은 번역 범위를 원하면 확장 `옵션`에서 `번역 API 사용`을 켠 뒤 API 제공자(LibreTranslate/DeepL/Custom)와 URL/Key를 설정하세요.
